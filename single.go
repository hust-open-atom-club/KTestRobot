...
func main(){
    ...
    patch_dir := "/home/lsc20011130/robot/linux/a.patch" //patch file's dir
    ...
    for {
		...
		if strings.HasPrefix(line, "diff --git a"){
            ...
            if sub_line[index - 1] != 'c' {
                continue
            }
			//changed file's dir
        	dir := sub_line[0:index]  
            index_l, index_r := index - 2, index - 2
            for {
                index_l--
                if sub_line[index_l] == '/' {
                    break
            ...
            filename := sub_line[index_l + 1 : index_r]
			args := []string{"/home/lsc20011130/robot/cmd.py", patch_dir, dir, filename}           
            ...
            file1 := "../logss/" + filename + "_pre_smatch_warn.log"
            ...
            file2 := "../logss/" + filename + "_pre_smatch_error.log"
            ...
            file3 := "../logss/" + filename + "_after_smatch_warn.log"
            ...
            file4 := "../logss/" + filename + "_pre_smatch_error.log"
            ...
            file5 := "../log_analysis_warning/" + filename + "_warn_situation.log"
            ...
            file6 := "../log_analysis_error/" + filename + "_error_situation.log"
